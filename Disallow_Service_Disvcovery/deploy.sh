...
WEBHOOK_NAME="disable-service-discovery-enforcer"
...
echo "✅ Now the cluster will block pods that don't explicitly set:"
echo "- dnsPolicy: Default"
echo "- enableServiceLinks: false"
