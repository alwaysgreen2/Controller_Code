...
WEBHOOK_NAME="docker-security-webhook"
NAMESPACE="webhook-demo"
IMAGE="${DOCKERHUB_USERNAME}/${WEBHOOK_NAME}:latest"
CERT_MANAGER_VERSION="v1.17.0"

# 1) Write main.go to enforce Docker security policies
cat <<'EOF' > main.go
package main
...
echo "✅ Docker Security Webhook deployed:"
echo "- Blocks Docker-in-Docker containers"
echo "- Prevents Docker socket mounts"
echo "- Skips validation for webhook-demo namespace"
echo "- Uses cert-manager CA injection"
